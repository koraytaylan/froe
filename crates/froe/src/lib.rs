...
pub use writer::{
    ...
    ExternalBinaryFootprint, FileDeletionFailure, ImportedIndex, JournalLineRemoval,
    JournalRemovalReason, LuceneImportOptions, LuceneImportOutcome, LuceneImportPlan, NoWorkReason,
    OrphanedVersionHistoryReport, PlannedImport, PreparedCompaction, PreparedLuceneImport,
    PreparedReindex, RecoveryBackupPolicy, RecoveryBackupSurvey, RecoveryOutcome, ReindexAction,
    ReindexOptions, ReindexOutcome, ReindexPlan, ReindexWarning, StaleArchiveReason, WorkDirectory,
    WritableRepository, backup, backup_with_progress, compact, compact_with_progress,
    lucene_import, lucene_import_with_progress, plan_compaction, plan_compaction_with_progress,
    plan_lucene_import, plan_reindex, plan_reindex_with_progress, recover_journal,
    recover_journal_with_progress, reindex, reindex_with_progress, restore, restore_with_progress,
    survey_archive_indexes, survey_recovery_backups,
};
