...
| --- | --- | --- | --- |
| *To be filled by task 1007 as it lands each refusal, with the neutralization run serially against a separate target directory and its failure quoted verbatim.* | | | |

#### Fault and subprocess tests

| Cutpoint | Fault model | Named test | Asserted prefix |
| --- | --- | --- | --- |
| *To be filled by task 1007 as it arms each cutpoint named in the mutation table above.* | | | |
